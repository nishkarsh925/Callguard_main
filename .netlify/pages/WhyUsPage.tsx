        ...
        <section className="relative h-[60vh] min-h-[400px] flex items-center justify-center overflow-hidden bg-kalka-charcoal">
          ...
          <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h1 className="text-5xl sm:text-6xl md:text-7xl font-black text-white leading-tight mb-4">
              Why <span className="text-transparent bg-clip-text bg-gradient-to-r from-kalka-red to-orange-500">Choose Us</span>
            </h1>
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
              Trusted by hundreds of customers for reliable and professional service
            </p>
          </div>
        </section>
        <WhyChooseUs />
